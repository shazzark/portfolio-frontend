  ...
  categories: [
    {
      ...
      skills: [
        ...
        { id: 4, name: "TypeScript", icon: "typescript", years: 2, level: 85 },
        { id: 5, name: "JavaScript", icon: "javascript", years: 4, level: 95 },
        { id: 6, name: "HTML5", icon: "html5", years: 5, level: 95 },
        { id: 7, name: "CSS3", icon: "css3", years: 5, level: 90 },
      ],
    },
